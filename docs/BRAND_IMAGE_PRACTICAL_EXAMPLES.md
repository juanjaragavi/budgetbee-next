# BudgetBee Image Generation - Practical Examples
...
```text
Generate a hyper-realistic, professional stock photograph for a US financial services website with BudgetBee brand elements.
...
OUTPUT: Seamlessly integrated brand photography that communicates financial confidence, growth (arrows), and trust (stars) for BudgetBee's US financial services platform.
```
...
OUTPUT: Professional office scene with seamless BudgetBee brand integration, communicating competence, upward progress, and financial trust.
```
...
OUTPUT: Lifestyle shopping scene with BudgetBee branding that communicates financial empowerment, smart spending, and the rewarding experience of financial confidence.
```
...
- ❌ Not aligned with BudgetBee identity

### New Branded Images

- ✅ BudgetBee-specific brand colors (#D72638, #003DA5)
- ✅ Consistent visual language (arrows = growth, stars = trust)
- ✅ Custom, unique to BudgetBee
