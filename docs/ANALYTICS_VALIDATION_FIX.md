...
- Tests were running on `localhost:3007` (development environment)
...
```bash
http://localhost:3007/?utm_source=test&utm_medium=cpc&utm_campaign=test_campaign
```
...
```bash
http://localhost:3007/blog/some-article
http://localhost:3007/financial-solutions/some-product
```
