...
export function generateMetadata() {
  return {
    title: "Customize Your Roblox Avatar for Free — BudgetBee",
    description:
      "Unlock premium avatar items without spending Robux. Free accessories, clothing, and limited items.",
    keywords:
      "free roblox avatar items, roblox free clothing, customize roblox free",
  };
}

export default function RobuxPromiseP7() {
  return (
    <GamingPromiseTemplate
      themeColor={ROBLOX_THEME.color}
      themeColorDark={ROBLOX_THEME.colorDark}
      badge="ROBLOX REWARDS"
      title="Customize Your Roblox Avatar for Free"
      subtitle="Unlock premium avatar items without spending Robux. Free accessories, clothing, and limited items."
      heroImage={{
      ...
      cta={{
        ...
        href: "/gaming/robux-reward-p7",
      }}
      extraCtas={[
        { label: "See safe Robux tips", href: "/gaming/robux-reward-p7" },
        { label: "Learn legal methods", href: "/gaming/robux-reward-p7" },
      ]}
      stickyBanner={{
        badge: "Robux Rewards",
