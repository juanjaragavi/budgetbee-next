...
export function generateMetadata() {
  return {
    title: "V-Bucks Earning Without Scams — BudgetBee",
    description:
  ...
  return (
    <GamingPromiseTemplate
      ...
      cta={{
        ...
        href: "/gaming/fortnite-reward-p3",
      }}
