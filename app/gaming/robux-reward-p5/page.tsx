...
export function generateMetadata() {
  return {
    title: "Gift Card Earning Apps — Complete Guide for Gamers — BudgetBee",
    description:
      "Every app that lets you earn Roblox gift cards, ranked by earning potential and ease of use.",
    keywords:
      "gift card apps gamers, earn gift cards roblox, gaming reward apps",
  };
}

export default function RobuxRewardP5() {
  return (
    <GamingRewardTemplate
      themeColor={ROBLOX_THEME.color}
      themeColorDark={ROBLOX_THEME.colorDark}
      badge="VERIFIED METHODS"
      title="Gift Card Earning Apps — Complete Guide for Gamers"
      subtitle="Every app that lets you earn Roblox gift cards, ranked by earning potential and ease of use."
      heroImage={{
