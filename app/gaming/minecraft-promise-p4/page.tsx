...
export function generateMetadata() {
  return {
    title: "Minecraft Marketplace Best Deals — BudgetBee",
    description:
  ...
  return (
    <GamingPromiseTemplate
      ...
      cta={{
        ...
        href: "/gaming/minecraft-reward-p4",
      }}
