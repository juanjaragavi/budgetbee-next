...
export function generateMetadata() {
  return {
    title: "Cashback Apps Every Gamer Needs in 2026 — BudgetBee",
    description:
      "These cashback apps pay you for things you already do — and the earnings stack up fast.",
    keywords: "cashback apps gamers, gaming cashback, earn money gaming apps",
  };
}

export default function RobuxRewardP6() {
  return (
    <GamingRewardTemplate
      themeColor={ROBLOX_THEME.color}
      themeColorDark={ROBLOX_THEME.colorDark}
      badge="VERIFIED METHODS"
      title="Cashback Apps Every Gamer Needs in 2026"
      subtitle="These cashback apps pay you for things you already do — and the earnings stack up fast."
      heroImage={{
