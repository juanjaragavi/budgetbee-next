...
export function generateMetadata() {
  return {
    title: "Minecraft Rewards and Loot Guide — BudgetBee",
    description:
...
export default function MinecraftPromiseP2() {
  return (
    <GamingPromiseQuizHost quiz={GAMING_QUIZ_CONFIGS.minecraftQuiz02}>
      <GamingPromiseTemplate
        themeColor={MINECRAFT_THEME.color}
        themeColorDark={MINECRAFT_THEME.colorDark}
        badge="MINECRAFT REWARDS"
        title="Minecraft Rewards and Loot Guide"
        ...
        cta={{
          ...
          href: "/gaming/minecraft-reward-p2",
        }}
