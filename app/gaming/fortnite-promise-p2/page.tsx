...
export function generateMetadata() {
  return {
    title: "Fortnite Rewards and Battle Pass Tips — BudgetBee",
    description:
...
export default function FortnitePromiseP2() {
  return (
    <GamingPromiseQuizHost quiz={GAMING_QUIZ_CONFIGS.fortniteQuiz02}>
      <GamingPromiseTemplate
        themeColor={FORTNITE_THEME.color}
        themeColorDark={FORTNITE_THEME.colorDark}
        badge="FORTNITE REWARDS"
        title="Fortnite Rewards and Battle Pass Tips"
        ...
        cta={{
          ...
          href: "/gaming/fortnite-reward-p2",
        }}
