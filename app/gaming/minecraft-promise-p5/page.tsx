...
export function generateMetadata() {
  return {
    title: "Minecraft Skin Packs Without Paying — BudgetBee",
    description:
  ...
  return (
    <GamingPromiseTemplate
      ...
      cta={{
        ...
        href: "/gaming/minecraft-reward-p5",
      }}
