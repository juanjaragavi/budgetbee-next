...
export function generateMetadata() {
  return {
    title: "Minecraft Gift Cards: Free Methods That Work — BudgetBee",
    description:
  ...
  return (
    <GamingPromiseTemplate
      ...
      cta={{
        ...
        href: "/gaming/minecraft-reward-p7",
      }}
