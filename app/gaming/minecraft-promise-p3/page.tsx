...
export function generateMetadata() {
  return {
    title: "Free Minecraft Skins and Content — BudgetBee",
    description:
  ...
  return (
    <GamingPromiseTemplate
      ...
      cta={{
        ...
        href: "/gaming/minecraft-reward-p3",
      }}
