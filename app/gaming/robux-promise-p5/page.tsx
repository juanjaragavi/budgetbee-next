...
export function generateMetadata() {
  return {
    title: "Roblox Promo Codes That Actually Work in 2026 — BudgetBee",
    description:
      "Updated list of active Roblox promo codes plus the best ways to get notified about new ones.",
    keywords: "roblox promo codes 2026, active roblox codes, roblox free items",
  };
}

export default function RobuxPromiseP5() {
  return (
    <GamingPromiseTemplate
      themeColor={ROBLOX_THEME.color}
      themeColorDark={ROBLOX_THEME.colorDark}
      badge="ROBLOX REWARDS"
      title="Roblox Promo Codes That Actually Work in 2026"
      subtitle="Updated list of active Roblox promo codes plus the best ways to get notified about new ones."
      heroImage={{
      ...
      cta={{
        ...
        href: "/gaming/robux-reward-p5",
      }}
      extraCtas={[
        { label: "See safe Robux tips", href: "/gaming/robux-reward-p5" },
        { label: "Learn legal methods", href: "/gaming/robux-reward-p5" },
      ]}
      stickyBanner={{
        badge: "Robux Rewards",
