...
export function generateMetadata() {
  return {
    title: "Free Fortnite Skins: Legit Methods — BudgetBee",
    description:
  ...
  return (
    <GamingPromiseTemplate
      ...
      cta={{
        ...
        href: "/gaming/fortnite-reward-p4",
      }}
