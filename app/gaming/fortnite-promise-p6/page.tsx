...
export function generateMetadata() {
  return {
    title: "Fortnite Rewards Roundup 2026 — BudgetBee",
    description:
  ...
  return (
    <GamingPromiseTemplate
      ...
      cta={{
        ...
        href: "/gaming/fortnite-reward-p6",
      }}
