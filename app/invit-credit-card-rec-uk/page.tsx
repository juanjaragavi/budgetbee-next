      ...
      <article className="text-left bg-white py-8 md:py-12 w-11/12 mx-auto">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-center text-[#E7B739] font-bold text-lg md:text-2xl leading-6 md:leading-8 mb-4">
            ...
            <section className="text-left mb-6">
              <div className="bg-gray-50 border border-gray-200 rounded-md px-4 py-6 relative">
                <div
                  className="absolute left-0 top-0 h-full w-1 bg-[#E7B739] rounded-l-md"
                  aria-hidden="true"
                />
                <h3 className="text-[#E7B739] text-xl font-semibold mb-2">
                  Well Done
                </h3>
