    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        <article>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Yotta reinvents credit card rewards with prize-linked
                  spending. Instead of earning points that take months to
                  redeem, you get instant winning opportunities on every single
                  transaction—no caps, no categories, no rotating bonuses.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="bg-gradient-to-br from-primary-accent to-primary-light/20 p-6 rounded-xl border border-primary">
                  ...
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li className="flex items-start">
                      <span className="text-primary-dark mr-2">✓</span>1 in 75
                      odds with direct deposit
                    </li>
                    <li className="flex items-start">
                ...
                <div className="bg-gradient-to-br from-primary-accent50 to-cyan-50 p-6 rounded-xl border border-primary">
                  ...
                  <p className="text-gray-600 mb-4">
                    ...
                    reimbursements directly to their account—no forms, no hoops
                    to jump through.
                  </p>
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li className="flex items-start">
          ...
          <section className="py-12 md:py-16 bg-gradient-to-br from-purple-50 to-primary-light/50">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              ...
              <div className="max-w-4xl mx-auto">
                <div className="grid md:grid-cols-3 gap-8">
                  <div className="bg-white p-6 rounded-xl shadow-lg border-2 border-purple-200">
                    ...
                    <p className="text-gray-600">
                      ...
                      purchase—groceries, gas, dining, travel—automatically
                      enters you into the Lucky Swipe sweepstakes. No manual
                      entry needed.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg border-2 border-indigo-200">
                    ...
                    <p className="text-gray-600">
                      ...
                      purchase a random integer between 0 and your odds
                      threshold. If it draws 0, you win up to 100% cash back.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg border-2 border-primary">
                    ...
                    <p className="text-gray-600">
                      Winners receive instant notification through the Yotta
                      app. Your prize (up to $5,000 or 100% of purchase amount)
                      is credited to your account within 30 days—no redemption
                      forms required.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-8 bg-white p-6 rounded-xl border-2 border-purple-300">
                  ...
                  <p className="text-gray-600 mt-3 text-sm italic">
                    This happens instantly for <em>every</em> transaction—no
                    caps, no categories, no limits on how many times you can
                    win.
                  </p>
                </div>
              </div>
          ...
          <section className="py-12 md:py-16 bg-white">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  See how Yotta's gamified approach compares to conventional
              ...
              <div className="max-w-5xl mx-auto overflow-x-auto">
                <table className="w-full bg-white border border-gray-200 rounded-lg">
                  <thead className="bg-gradient-to-r from-purple-600 to-primary-light/600 text-white">
                    <tr>
                  ...
                  <tbody className="divide-y divide-gray-200">
                    ...
                    <tr className="hover:bg-purple-50">
                      ...
                      <td className="px-6 py-4 text-gray-700">
                        Automatic reimbursement within 30 days (no action
                        needed)
                      </td>
                      <td className="px-6 py-4 text-gray-600">
                    ...
                    <tr className="hover:bg-purple-50">
                      ...
                      <td className="px-6 py-4 text-gray-600">
                        Often limited to rotating categories or specific
                        merchants
                      </td>
                    </tr>
                    <tr className="hover:bg-purple-50">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      ...
                      most transactions won't win prizes. If you prefer
                      guaranteed returns, a traditional cash back card (earning
                      1.5-2% on all purchases) may provide more consistent
                      value. However, if you enjoy the thrill of potentially
                      winning big and don't mind occasional losses, Yotta's
                      gamified approach can be significantly more rewarding.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <ul className="space-y-4">
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Category-specific cards (5% on gas, 3% on dining)
                          often deliver higher guaranteed returns
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          If credit building is your primary goal, consider
                          cards that report to all three bureaus with longer
                          track records
                        </p>
                      </div>
                    </li>
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Yotta credit cards are only available in 42 states
          ...
          {/* CTA Section */}
          <section className="py-12 md:py-16 bg-gradient-to-r from-purple-600 to-primary-light/700 text-white">
