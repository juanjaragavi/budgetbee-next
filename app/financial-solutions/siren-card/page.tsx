    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        <article>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className="text-lg md:text-xl text-primary-accent mb-6">
                    ...
                    technology. Get paid up to 2 days early, spend with a
                    premium metal card, and never pay interest or fees—100%
                    guaranteed by cred.ai.
                  </p>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  SIREN isn't just another card—it's a complete financial
                  wellness tool designed specifically for Starbucks partners.
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                {/* Feature 1 */}
                <div className="bg-gradient-to-br from-primary-accent to-primary-light/20 p-6 rounded-xl border border-primary">
                  <div
                  ...
                  <p className="text-gray-600 mb-4">
                    SIREN's automatic credit optimizer works in the background
                    to build your credit score without you having to think about
                    it. Use it like a debit card while the technology handles
                    credit optimization automatically.
                  </p>
                ...
                {/* Feature 2 */}
                <div className="bg-gradient-to-br from-primary-accent50 to-cyan-50 p-6 rounded-xl border border-primary">
                  ...
                  <p className="text-gray-600 mb-4">
                    ...
                    in fees or interest—guaranteed. If the automated system
                    fails and you're charged, cred.ai covers it on your behalf.
                  </p>
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li className="flex items-start">
                      <span className="text-primary-dark mr-2">✓</span>
                ...
                {/* Feature 3 */}
                <div className="bg-gradient-to-br from-purple-50 to-primary-light/50 p-6 rounded-xl border border-purple-200">
          ...
          {/* How It Works */}
          <section className="py-12 md:py-16 bg-gradient-to-br from-primary-accent to-primary-light/20">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  SIREN is unique: it replaces your debit card but functions as
                  a credit card behind the scenes. Here's how the magic happens:
                </p>
              </div>
                ...
                <div className="grid md:grid-cols-4 gap-6">
                  <div className="bg-white p-6 rounded-xl shadow-lg border-2 border-primary">
                    ...
                    <p className="text-gray-600">
                      Use your premium metal SIREN Card anywhere Visa is
                      accepted. It works exactly like a debit card—no thinking
                      required, no balance management stress.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg border-2 border-primary">
                    ...
                    <p className="text-gray-600">
                      ...
                      This means your purchases report to credit bureaus,
                      building your credit history automatically.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg border-2 border-orange-200">
                    ...
                    <p className="text-gray-600">
                      ...
                      history builds. You're becoming a "credit rockstar"
                      without doing anything differently.
                    </p>
                  </div>
                </div>

                <div className="mt-8 bg-white p-6 rounded-xl border-2 border-primary">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li className="flex items-start">
                      ...
                      <span>
                        ATM withdrawals at 55,000+ free ATMs are technically
                        cash advances, but still covered by the guaranty
                      </span>
                    </li>
                  </ul>
                  <p className="text-gray-600 mt-3 text-sm italic">
                    This unique structure allows SIREN to build your credit
                    while protecting you from all credit card costs.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="py-12 md:py-16 bg-white">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8">
                ...
                {/* 24/7 Support */}
                <div className="bg-gradient-to-br from-primary-accent600 to-primary-light/700 text-white p-8 rounded-xl">
                  <div className="w-16 h-16 bg-white bg-opacity-20 rounded-lg flex items-center justify-center mb-6">
                    <svg
                      className="w-8 h-8"
                      fill="none"
                  ...
                  <p className="text-primary-dark100 mb-4 leading-relaxed">
                    Need help at 3 AM? No problem. SIREN provides
                    around-the-clock live customer support via phone, email, and
                    in-app chat.
                  </p>
                  <ul className="space-y-2 text-primary-dark200">
                    <li className="flex items-start">
                      <span className="text-primary-dark300 mr-2">✓</span>
                ...
                <div className="bg-gradient-to-br from-purple-600 to-pink-600 text-white p-8 rounded-xl">
                  ...
                  <p className="text-purple-100 mb-4 leading-relaxed">
                    Access cash at over 55,000 ATMs nationwide without paying
                    ATM fees. Use the in-app ATM finder to locate the nearest
                    free machine.
                  </p>
                ...
                <div className="bg-gradient-to-br from-primary to-primary-dark text-white p-8 rounded-xl">
                  ...
                  <p className="text-primary-accent mb-4 leading-relaxed">
                    SIREN includes everything you need for modern banking:
                    mobile check deposit, account linking, budgeting tools, and
                    more.
                  </p>
          ...
          <section className="py-12 md:py-16 bg-gradient-to-br from-primary-accent to-primary-light/20">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  SIREN is specifically designed for Starbucks partners and
                  offers unique benefits for this community:
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                ...
                <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-primary">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start">
                      <span className="text-primary-dark font-bold text-xl mr-3">
                        ✓
                      </span>
                      <div>
                ...
                <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-primary300">
                  <div className="flex items-center mb-6">
                    <div className="w-12 h-12 bg-primary-accent0 rounded-full flex items-center justify-center mr-4">
                      <svg
                        className="w-6 h-6 text-white"
                        fill="none"
                        stroke="currentColor"
                  ...
                  <ul className="space-y-4">
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Functions like debit but reports as credit—best of
                          both worlds in one card
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start">
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Even if automation fails, the cred.ai Guaranty
                          protects you from all fees and interest
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start">
          ...
          >
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              <p className="text-xl text-primary-accent mb-8 max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  href="/financial-solutions/siren-card-requirements"
                  variant="secondary"
                  className="bg-primary text-white hover:bg-primary-dark border-2 border-white"
                >
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                ...
                >
                  ...
                  <p className="text-gray-600 mb-4">
                    Compare hybrid cards like SIREN vs traditional credit cards
