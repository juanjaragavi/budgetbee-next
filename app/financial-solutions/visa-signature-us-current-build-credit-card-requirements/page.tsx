            ...
            <div className="my-8 text-left sm:text-left">
              ...
              <ul className="list-disc pl-6 mb-8 text-gray-700 space-y-2">
                <li>
                  ...
                  at least 580-620. The card is accessible to those with fair
                  credit or limited credit history, making it ideal for
              ...
              <ul className="list-disc pl-6 mb-8 text-gray-700 space-y-2">
                <li>
                  ...
                  required income threshold is generally accessible, focusing on
              ...
              <ul className="list-disc pl-6 mb-8 text-gray-700 space-y-2">
                <li>
                  ...
                  exceptions may be considered based on individual
                  circumstances.
                </li>
              </ul>
              <h2 className="text-2xl font-bold text-gray-800 mb-4">
              ...
              <p className="text-gray-700 mb-8">
                ...
                credit score improvements within 3-6 months, opening doors to
