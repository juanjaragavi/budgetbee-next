...
export default function BlogArchivePage() {
  ...
  const allPosts: PostItem[] = [
    ...
    {
      title:
        "Blue Cash Preferred® Card from American Express: Maximize Your Cash Back Rewards | BudgetBee",
    ...
    {
      title: "Capital One Quicksilver Student Credit Card Benefits | BudgetBee",
    ...
    {
      title:
        "Citi Double Cash® Card Benefits: Earn 2% Back Everywhere | BudgetBee",
    ...
    {
      title: "Citi Simplicity® Card Benefits | BudgetBee",
    ...
    {
      title: "Discover it® Student Chrome Credit Card Benefits | BudgetBee",
    ...
    {
      title:
        "Wells Fargo Active Cash® Card: Unlimited 2% Cash Back on Everything | BudgetBee",
    ...
    {
      title: "Wells Fargo Autograph℠ Card Benefits | BudgetBee",
    ...
    {
      title: "Chase Freedom Unlimited® Credit Card Benefits | BudgetBee",
    ...
    {
      title: "DoorDash Rewards Mastercard® Benefits | BudgetBee",
    ...
    {
      title: "First Digital NextGen Mastercard® Benefits | BudgetBee",
    ...
    {
      title: "TD FlexPay Credit Card Benefits | BudgetBee",
    ...
    {
      title:
        "Titanium Rewards Visa Signature® Credit Card Benefits | BudgetBee",
    ...
    {
      title: "U.S. Bank Cash+® Visa Signature® Card Benefits | BudgetBee",
    ...
    {
      title: "Current Build Visa Signature® Credit Card Benefits | BudgetBee",
    ...
    {
      title:
        "Self Credit Builder Account + Visa Card: Build Credit with One Ecosystem | BudgetBee",
    ...
    {
      title: "Yotta Credit Card: Win Cash Back With Every Purchase | BudgetBee",
    ...
    {
      title:
        "Avant Credit Card: Your Path to Healthy Credit Starts Here | BudgetBee",
    ...
    {
      title: "Klarna Card: Pay Now or Pay Later Everywhere - BudgetBee",
      slug: "klarna-card",
      description:
    ...
    {
      title:
        "Affirm Card: Pay Over Time with Flexible Payment Plans - BudgetBee",
      slug: "affirm-card",
      description:
    ...
    {
      title: "Upgrade OneCard: Pay Now or Pay Later Credit Card | BudgetBee",
    ...
    {
      title:
        "Inflation-Proof Your Life: 7 Smart Money Moves to Make When Prices Are High | BudgetBee",
    ...
    {
      title: "Best Personal Loans in the US: Your Complete Guide | BudgetBee",
    ...
    {
      title: "Top Rewards Credit Cards to Maximize Your Spending | BudgetBee",
    ...
    {
      title:
        "Credit Cards - Types, Benefits, and Keys to Financial Health | BudgetBee",
    ...
    {
      title: "Practical Guide to Getting Out of Debt | BudgetBee",
    ...
    {
      title: "Top Credit Cards With No Annual Fees | BudgetBee",
    ...
    {
      title: "Personal Loans - A Strategy for Managing Debt | BudgetBee",
    ...
    {
      title:
        "5 Essential Tips for Choosing an Online Loan: Quick Guide | BudgetBee",
    ...
    {
      title: "Best Credit Cards with 0% Intro APR Offers in the US | BudgetBee",
    ...
    {
      title:
        "Beyond Spreadsheets: Create a Personal Finance Budget You'll Actually Stick To | BudgetBee",
