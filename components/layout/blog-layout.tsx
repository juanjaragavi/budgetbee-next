...
export function BlogLayout({ children, metadata }: BlogLayoutProps) {
  const {
    ...
    featuredImage = "https://media.topfinanzas.com/images/kardtrust/favicon.webp",
    excerpt = "",
    views = 0,
    commentCount = 0,
  } = metadata || {};
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start">
                  ...
                  <div className="text-left sm:text-left">
                    ...
                    <div className="flex justify-center sm:justify-start space-x-4">
                      ...
                      <a
                        href="#"
                        className="text-primary-accent hover:text-primary-dark"
                      >
                        <svg
                          fill="currentColor"
                          viewBox="0 0 24 24"
            ...
            <div className="lg:col-span-3">
              ...
              <div className="mb-8">
                ...
                <div className="space-y-4">
                  ...
                  >
                    <div className="relative h-32 rounded-xl overflow-hidden">
                      <Image
                        src="https://us.budgetbeepro.com/wp-content/uploads/2023/11/Top_Finanzas_como_salir_de_deudas.webp" // Updated Image
                  ...
                  >
                    <div className="relative h-32 rounded-xl overflow-hidden">
                      <Image
                        src="https://media.topfinanzas.com/images/kardtrust/choosing-online-loan-uk.webp" // Updated Image
              ...
              {/* Newsletter signup */}
              <div className="p-4 bg-primary-accent rounded-xl">
                ...
                <div className="space-y-2">
                  <input
                    ...
                    className="w-full px-3 py-1.5 text-[10px] border border-gray-300 rounded-xl focus:outline-none focus:ring-1 focus:ring-primary"
                  />
