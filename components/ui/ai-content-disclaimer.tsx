...
export function AIContentDisclaimer() {
  ...
  return (
    <div className="mt-10 pt-6 border-t border-gray-200">
      <div className="bg-[#FFF9E6] border-l-4 border-[#F7B500] rounded-xl p-6">
        <div className="flex items-start">
          <div className="flex-shrink-0 mr-4">
            <div className="relative w-16 h-16 rounded-full overflow-hidden border-2 border-[#F7B500]">
              <Image
                src={author.imageUrl}
                alt={author.name}
                fill
                ...
                onError={(e) => {
                  ...
                  if (e.currentTarget.parentElement) {
                    e.currentTarget.parentElement.innerHTML = `<div class="w-full h-full flex items-center justify-center bg-[#FFF9E6] text-gray-900 font-semibold text-lg">
                        ${author.name
                          .split(" ")
                          .map((n) => n[0])
                          .join("")}
          ...
          <div className="flex-grow">
            ...
            <p className="text-sm text-left sm:text-left text-gray-700 mb-2">
...
export function AIContentDisclaimerStatic() {
  ...
  return (
    <div className="mt-10 pt-6 border-t border-gray-200">
      <div className="bg-primary-accent rounded-xl p-6">
        <div className="flex items-start">
          <div className="flex-shrink-0 mr-4">
            <div className="relative w-16 h-16 rounded-full overflow-hidden border-2 border-white">
              <Image
                ...
                onError={(e) => {
                  e.currentTarget.style.display = "none";
                  if (e.currentTarget.parentElement) {
                    e.currentTarget.parentElement.innerHTML = `<div class="w-full h-full flex items-center justify-center bg-primary-accent text-primary-dark font-semibold text-lg">
                        ${author.name
                          .split(" ")
                          .map((n) => n[0])
                          .join("")}
