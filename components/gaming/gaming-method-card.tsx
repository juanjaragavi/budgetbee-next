...
export interface MethodCardProps {
  ...
  /** Short description */
  description: string;
  /** Trust signal badges (e.g. "Verified", "Popular") */
  badges?: string[];
  ...
  /** Optional secondary links (Android/iOS) */
  downloadLinks?: { label: string; href: string }[];
  /** Theme color for accents */
  themeColor: string;
  /** Emoji or icon character for the card header */
  icon?: string;
}

export default function GamingMethodCard({
  name,
  description,
  badges,
  features,
