...
export default function CreditCardForm() {
  ...
  return (
    <div className="bg-white flex flex-col min-h-screen">
      {/* Yellow Quiz Header */}
      <div className="bg-[#F7B500] py-4 px-4 flex justify-center items-center">
      ...
      <div className="relative flex-1 overflow-y-auto">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="px-4 pt-6 pb-20 max-w-md mx-auto"
          >
      ...
      <div className="p-4 flex-none bg-white border-t border-gray-200">
        <div className="w-full max-w-md mx-auto">
          <div className="flex justify-center mb-2">
            <p className="text-xs text-gray-500">
              <span className="font-bold">
                {Math.floor(285 + Math.random() * 20)}
              </span>{" "}
              successful requests today
            </p>
          </div>
          {isRegisteredUser && step === 2 && (
            <div className="text-xs text-primary-dark text-center mb-2">
