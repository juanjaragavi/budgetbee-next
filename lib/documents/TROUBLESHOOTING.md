...
2. Go to Console tab
3. Navigate to <http://localhost:3007/quiz>
...
2. Open <http://localhost:3007/quiz> in your browser
...
**Solution:** Clear cookies for localhost:3007
...
```javascript
// In browser console on localhost:3007
fetch("/api/sheets", {
  method: "POST",
...
- [ ] Navigated to <http://localhost:3007/quiz>
- [ ] Browser DevTools Console is open
- [ ] Browser DevTools Network tab is open
- [ ] Cookies cleared for localhost:3007
